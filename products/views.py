...
class ReviewUpdateView(View):
    def get(self, request):
        ...
        update_review_form = AddReviewForm(instance=review)
        context = {
            'update_review_form': update_review_form
        }
        return render(request, 'book/review_update_form.html', context=context)
    ...
    def post(self, request, pk):
        ...
        if update_review_form.is_valid():
            ...
            return render(request, 'book/review_update.html', context={'update_review_form':update_review_form})